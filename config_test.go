...
func TestResolveConfigValue_Priority(t *testing.T) {
	...
	os.Setenv("TEST_RESOLVE_VAR", "from_env")
...
func TestResolveConfigValue_NoSources(t *testing.T) {
	...
	os.Unsetenv("TEST_EMPTY_RESOLVE")
...
func TestResolveAllConfig(t *testing.T) {
	...
	os.Unsetenv("TEST_ALL_A")
	os.Unsetenv("TEST_ALL_B")
...
func TestValidatePluginConfig(t *testing.T) {
	...
	os.Unsetenv("V_REQUIRED")
	os.Unsetenv("V_OPTIONAL")
	...
	// Satisfy via env
	os.Setenv("V_REQUIRED", "yes")
	defer os.Unsetenv("V_REQUIRED")
	errs = ValidatePluginConfig("v", nil)
	if len(errs) != 0 {
